...
"""This is an example of the run"""

host = HostElement('insta.png') #Full path of the cover image
password = filename = None  #Default value is None since we're not implementing password
filename = 'mess.png' #Full path of the secret image
with open(filename, 'rb') as myfile:
              message = myfile.read()
